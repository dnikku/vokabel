<template>
  <div class="question">{{ value.nr }}: {{ value.text_de }}</div>
  ...
  <div class="question en" v-show="hintEN">{{ value.text_en }}</div>
  <div class="question ro" v-show="hintRO">{{ value.text_ro }}</div>

  <div class="answer" v-show="showAnswer">- {{ value.answer_de }}</div>
  <div class="answer en" v-show="showAnswer && hintEN">- {{ value.answer_en }}</div>
  <div class="answer ro" v-show="showAnswer && hintRO">- {{ value.answer_ro }}</div>
